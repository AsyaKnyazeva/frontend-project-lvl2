...
const testCases = [
  ...
  {
    file1: jsonFile1, file2: jsonFile2, format: 'stylish', expected: expectedStylish,
  },
  {
    file1: yamlFile1, file2: yamlFile2, format: 'stylish', expected: expectedStylish,
  },
  {
    file1: jsonFile1, file2: jsonFile2, format: 'plain', expected: expectedPlain,
  },
  {
    file1: yamlFile1, file2: yamlFile2, format: 'plain', expected: expectedPlain,
  },
  {
    file1: jsonFile1, file2: jsonFile2, format: 'json', expected: expectedJson,
  },
  {
